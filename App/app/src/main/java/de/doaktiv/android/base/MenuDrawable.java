...
public class MenuDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawLine(-AndroidUtils.dp(9), 0, AndroidUtils.dp(9) - AndroidUtils.dp(3.0f) * currentRotation, 0, paint);
        float endYDiff = AndroidUtils.dp(5) * (1 - Math.abs(currentRotation)) - AndroidUtils.dp(0.5f) * Math.abs(currentRotation);
        float endXDiff = AndroidUtils.dp(9) - AndroidUtils.dp(2.5f) * Math.abs(currentRotation);
        float startYDiff = AndroidUtils.dp(5) + AndroidUtils.dp(2.0f) * Math.abs(currentRotation);
        float startXDiff = -AndroidUtils.dp(9) + AndroidUtils.dp(7.5f) * Math.abs(currentRotation);
